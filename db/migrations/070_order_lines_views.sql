...
SELECT
    ...
    MAX(CASE WHEN predicate = 'quantity' THEN object_value END)::DECIMAL::INT AS quantity,
    ...
    (MAX(CASE WHEN predicate = 'quantity' THEN object_value END)::DECIMAL::INT
     * MAX(CASE WHEN predicate = 'order_line_unit_price' THEN object_value END)::DECIMAL(10,2))::DECIMAL(10,2) AS line_amount,
    MAX(CASE WHEN predicate = 'line_sequence' THEN object_value END)::DECIMAL::INT AS line_sequence,
